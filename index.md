...
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![The Home Page](/Users/shomil/Documents/GitHub/Avina Labs/Vision/Vision-Assets/Mockups/ucb_home_iphonexspacegrey_portrait.png) | ![Resources Screen](/Users/shomil/Documents/GitHub/Avina Labs/Vision/Vision-Assets/Mockups/ucb_resources_iphonexspacegrey_portrait.png) |
|                                                              |                                                              |
...
| :---------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :------------: |
|  Directory  | A list of information. Useful for member lists, team lists, inventory lists, etc. Tapping on a list item leads to a **detail page**. | ![lghs_clubs_iphonexspacegrey_portrait](/Users/shomil/Documents/GitHub/Avina Labs/Vision/Vision-Assets/Mockups/lghs_clubs_iphonexspacegrey_portrait.png) |    **Yes**     |
|     Map     | A rich map-based interface for your users. Useful for **indoor** or **outdoor** maps. | ![ucb_campusmap_iphonexspacegrey_portrait](/Users/shomil/Documents/GitHub/Avina Labs/Vision/Vision-Assets/Mockups/ucb_campusmap_iphonexspacegrey_portrait.png) |    **Yes**     |
|     Web     | A in-app interface for handling website links. **Can link to Google Forms for data-entry, website links, and pretty much anything else** | ![IMG_2719_iphonexspacegrey_portrait](/Users/shomil/Downloads/mockup (10)/IMG_2719_iphonexspacegrey_portrait.png) |     **No**     |
|    Text     | A quick way of displaying paragraphs of **text** or specific **messages** to your organization. | ![lghs_announcements](/Users/shomil/Documents/GitHub/Avina Labs/Vision/Vision-Assets/Mockups/lghs_announcements.png) |     **No**     |
|   Toolkit   | A toolkit-style page to bring together important **phone numbers**, **forms**, and basically anything of **uility**. | ![ucb_safety](/Users/shomil/Documents/GitHub/Avina Labs/Vision/Vision-Assets/Mockups/ucb_safety.png) |    **Yes**     |
|  Calendar   | All of your organization's calendars, centralized. Users can choose which calendars to show/hide at any given time. | ![ucb_events](/Users/shomil/Documents/GitHub/Avina Labs/Vision/Vision-Assets/Mockups/ucb_events.png) |    **Yes**     |
...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![image-20190321101046049](/Users/shomil/Library/Application Support/typora-user-images/image-20190321101046049.png) | ![image-20190321103922058](/Users/shomil/Library/Application Support/typora-user-images/image-20190321103922058.png) |
